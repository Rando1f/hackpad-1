# hackpad-P
a 3 key switch macropad made to make shortcuts and hotkeys easier to acess, the current firmware has a start/end recording button as well as one for changing languages
